      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {PROOF_ITEMS.map((item) => (
            <div key={item.metric} className="border-l-2 border-[var(--accent)] pl-5">
              <p className="text-3xl md:text-4xl font-display font-bold text-[var(--ink)] leading-none mb-2 metric-value">
                {item.metric}
              </p>
